...
Enables R users to inspect database structure and object metadata through DBI-compliant methods, including listing tables and fields and retrieving connection information.
...
* *WHEN* the user calls `dbGetInfo(drv)`
* *THEN* a named list SHALL be returned containing driver.version, max.connections, DBI.version, RODBC.version, and client.version
